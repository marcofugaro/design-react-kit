...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (placeholder) {
      return React.createElement(InputContainer, containerProps, React.createElement(Tag, _extends({}, attributes, sharedAttributes, {
...
var Rating = function Rating(props) {
  ...
  var legendContent = isLegendObject || isLegendString ? React.createElement("span", {
  ...
  return React.createElement(FormGroup, _extends({
    ...
    tag: "fieldset",
    className: wrapperClasses
  }, attributes), legend && React.createElement("legend", null, legendContent), safeInputs.map(function (id, i) {
    ...
    return React.createElement(React.Fragment, null, React.createElement(Input, _extends({
      ...
      disabled: readOnly
    }, extraFieldAttrs)), React.createElement(Label, {
      className: "full",
      "for": id
    }, React.createElement(Icon, {
      icon: "it-star-full",
...
var CardCategory = function CardCategory(props) {
  ...
  var categoryDate = date && React.createElement("span", {
    className: "data"
...
var TimelinePin = function TimelinePin(props) {
  ...
  var pinIcon = React.createElement("div", {
    className: "pin-icon"
  }, React.createElement(Icon, {
    icon: icon
  }));
  var pinLabel = React.createElement("div", {
    className: "pin-text"
  }, React.createElement("span", null, label));
  var pinTextNow = now && React.createElement("span", {
    className: "it-now-label d-none d-lg-flex"
  }, nowText);
  return React.createElement("div", {
    className: classes
  }, pinTextNow, React.createElement("div", _extends({
    className: innerClasses
...
var StepperHeaderElement = function StepperHeaderElement(props) {
  ...
  return React.createElement("li", _extends({}, attributes, {
    ...
    icon: iconName
  }), stepperNumber && React.createElement("span", {
    className: spanClass
  }, stepperNumber), children, icon && React.createElement(Icon, {
    icon: icon,
    className: iconClass
  }));
};
